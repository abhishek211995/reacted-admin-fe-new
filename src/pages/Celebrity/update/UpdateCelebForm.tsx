...
const UpdateCeleberityDetails = (props: any) => {
    const {
        user_id,
        first_name,
        last_name,
    ...
    const [serverity, setSeverity] = useState<any>('info')
    ...
    return (
        <FormikProvider value={formik}>
            <form autoComplete="off" noValidate onSubmit={formik.handleSubmit}>
                ...
                >
                    <Alert sx={{ width: "100%", color: "#fff" }} variant="filled" severity={serverity}>
                        {msg}
                    </Alert>
                </Snackbar>
            </form>
...
export default UpdateCeleberityDetails